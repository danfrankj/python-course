...
\texttt{func\_e(7, 7)} recursively calls \texttt{func\_e(6, 8)}, which returns \texttt{max(a, b)}.  Python allows for function definitions within functions, which we encounter with the function call \texttt{func\_e(7, -7)}.
\end{enumerate}
