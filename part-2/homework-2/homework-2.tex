...
In the next lecture, we will start with NumPy and SciPy, the two main Python libraries for scientific computing.  For this part of the assignment, you will get introduced to these libraries.  Here are three options for accessing NumPy and SciPy:
