...
Upload the files \texttt{myfirstscript.py}, \texttt{coordinates\_tuples.py}, and \texttt{coordinates\_dicts.py} to your Drop Box on Coursework.  Do not change the names of the files. \\

You can submit you answer to the bonus question either by uploading it electronically to your Drop Box or by bringing a hard-copy to class.
