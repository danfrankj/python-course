...
def grade(path):
    ...
    tuple_tests = init_tuples_tests()
    dict_tests = init_dicts_tests()
    TESTS = {'tuples': tuple_tests, 'dicts': dict_tests}                    

    total_tests = 0
    successes = 0
    for test in TESTS['tuples']:
        if run_tuples_test(tuples_func_table, **test):
            successes += 1
        total_tests += 1
    for test in TESTS['dicts']:
        if run_dicts_test(dicts_func_table, **test):
            successes += 1
        total_tests += 1
...
def run_tuples_test(tuples_func_table, i, name, input, output):
...
def run_dicts_test(dicts_func_table, i, name, input, output):
...
def create_test(i, name, input, output, type):
    return {'i': i, 'name': name, 'input': input, 'output': output}
...
def init_tuples_tests():
    ...
    tuple_tests.append(create_test(1, 'cart2cyl',
                tuples_testpt1_cart, tuples_testpt1_cyl, 'tuples'))
    tuple_tests.append(create_test(2, 'cyl2cart',
                tuples_testpt1_cyl, tuples_testpt1_cart, 'tuples'))
    tuple_tests.append(create_test(3, 'cart2sphere',
                tuples_testpt1_cart, tuples_testpt1_sphere, 'tuples'))
    tuple_tests.append(create_test(4, 'sphere2cart',
                tuples_testpt1_sphere, tuples_testpt1_cart, 'tuples'))
    tuple_tests.append(create_test(5, 'sphere2cyl',
                tuples_testpt1_sphere, tuples_testpt1_cyl, 'tuples'))
    tuple_tests.append(create_test(6, 'cyl2sphere',
                tuples_testpt2_cyl, tuples_testpt2_sphere, 'tuples'))
    tuple_tests.append(create_test(7, 'cart2cyl',
                tuples_testpt2_cart, tuples_testpt2_cyl, 'tuples'))
    tuple_tests.append(create_test(8, 'sphere2cart',
                tuples_testpt2_sphere, tuples_testpt2_cart, 'tuples'))
    tuple_tests.append(create_test(9, 'cyl2cart',
                tuples_testpt2_cyl, tuples_testpt2_cart, 'tuples'))
    tuple_tests.append(create_test(10, 'sphere2cyl',
                tuples_testpt2_sphere, tuples_testpt2_cyl, 'tuples'))

    tuple_tests.append(create_test(11, 'convert_points',
    ...
    tuple_tests.append(create_test(15, 'convert_points',
...
def init_dicts_tests():
    ...
    dict_tests.append(create_test(1, 'cart2cyl',
                dicts_testpt1_cart, dicts_testpt1_cyl, 'dicts'))
    dict_tests.append(create_test(2, 'cyl2cart',
                dicts_testpt1_cyl, dicts_testpt1_cart, 'dicts'))
    dict_tests.append(create_test(3, 'cart2sphere',
                dicts_testpt1_cart, dicts_testpt1_sphere, 'dicts'))
    dict_tests.append(create_test(4, 'sphere2cart',
                dicts_testpt1_sphere, dicts_testpt1_cart, 'dicts'))
    dict_tests.append(create_test(5, 'sphere2cyl',
                dicts_testpt1_sphere, dicts_testpt1_cyl, 'dicts'))
    dict_tests.append(create_test(6, 'cyl2sphere',
                dicts_testpt2_cyl, dicts_testpt2_sphere, 'dicts'))
    dict_tests.append(create_test(7, 'cart2cyl',
                dicts_testpt2_cart, dicts_testpt2_cyl, 'dicts'))
    dict_tests.append(create_test(8, 'sphere2cart',
                dicts_testpt2_sphere, dicts_testpt2_cart, 'dicts'))
    dict_tests.append(create_test(9, 'cyl2cart',
                dicts_testpt2_cyl, dicts_testpt2_cart, 'dicts'))
    dict_tests.append(create_test(10, 'cyl2sphere',
                dicts_testpt2_cyl, dicts_testpt2_sphere, 'dicts'))

    dict_tests.append(create_test(11, 'detect_type', dicts_testpt3_cart, 'cart', 'dicts'))
    dict_tests.append(create_test(12, 'detect_type', dicts_testpt3_cyl, 'cyl', 'dicts'))
    dict_tests.append(create_test(13, 'detect_type', dicts_testpt3_sphere, 'sphere', 'dicts'))
    dict_tests.append(create_test(14, 'detect_type', dicts_testpt2_cart, 'cart', 'dicts'))
    dict_tests.append(create_test(15, 'detect_type', dicts_testpt2_cyl, 'cyl', 'dicts'))
